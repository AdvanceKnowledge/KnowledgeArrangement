...
// 判断是否是iPhone X
#define isiPhoneX ([UIScreen instancesRespondToSelector:@selector(currentMode)] ? CGSizeEqualToSize(CGSizeMake(375.0*2, 812.0*2), [[UIScreen mainScreen] currentMode].size)||CGSizeEqualToSize(CGSizeMake(828.0, 896.0*2), [[UIScreen mainScreen] currentMode].size) : NO)
// home indicator
#define bottom_height (isiPhoneX ? 34:10)


#define MAXYEAR [[NSDate date] year]+1
#define MINYEAR [[NSDate date] year]-3
